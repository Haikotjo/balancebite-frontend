...
export default function HeroSection({ stats, navigate }) {
    return (
        <div className="rounded-[32px] border border-content/10 bg-gradient-to-br from-emerald-400/15 via-content/[0.06] to-cyan-400/15 p-6 shadow-2xl backdrop-blur-xl md:p-8">
            ...
            <div className="mb-5 flex flex-wrap gap-3">
                <HomeChip>Modern nutrition platform</HomeChip>
                <HomeChip>Community + personal copies</HomeChip>
            </div>

            <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-content md:text-6xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
                <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-content px-5 py-3 text-sm font-semibold text-page"
                >
                    Explore meals
                </button>
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-content/15 bg-content/5 px-5 py-3 text-sm font-semibold text-content"
                >
                    View diet plans
                </button>
            </div>
