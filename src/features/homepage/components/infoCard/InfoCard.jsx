...
export default function InfoCard({ icon: Icon, title, text, accentClass, gradient }) {
    return (
        <div className={`rounded-[32px] border border-content/10 bg-gradient-to-br ${gradient} p-6 shadow-2xl backdrop-blur-xl`}>
            ...
            <p className="mt-3 text-sm leading-6 text-content/70">
                {text}
            </p>
        </div>
    );
