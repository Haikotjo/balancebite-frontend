...
const MealCardCompact = ({ meal, hideOpenButton = false }) => {
        ...
        <CustomImage
            ...
            >
                ...
                <CustomBox className="flex items-center justify-between w-full z-10">
                    ...
                    {!hideOpenButton && <ButtonOpenMeal meal={meal} />}
                </CustomBox>
            </CustomBox>
            ...
            <CustomBox
                ...
                onClick={(e) => e.stopPropagation()}
            >
                <CustomTypography variant="paragraphCard" color="text-content" className=" truncate text-left pl-1">
                    {meal.name}
                </CustomTypography>
            </CustomBox>
        </CustomBox>
