...
import { shareMealApi } from "../../../../services/apiService.js";
import ErrorDialog from "../../../../components/layout/ErrorDialog.jsx";

const MealShareForm = ({ mealId }) => {
    ...
    const [dialogType, setDialogType] = useState("error"); // of "success"
    ...
    const handleShare = async () => {
        ...
        try {
            ...
            setDialogMessage(`Meal successfully shared with ${email}.`);
            setEmail("");
            setShowForm(false);
        } catch {
            setDialogType("error");
