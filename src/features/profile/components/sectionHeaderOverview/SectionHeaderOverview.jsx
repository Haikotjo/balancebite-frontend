...
const SectionHeader = ({ title, subtitle, infoText }) => {
    return (
        <CustomBox className="relative flex items-center justify-center my-4">
            ...
            <CustomBox className="relative bg-page px-6 text-center flex flex-col items-center">
                <CustomBox className="flex items-center gap-2">
                    ...
                    {infoText && (
                        <CustomBox className="group relative">
                            ...
                            <CustomBox className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-white dark:bg-gray-800 border border-border rounded-lg shadow-xl opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50">
